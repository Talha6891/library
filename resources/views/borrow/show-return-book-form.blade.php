...
<div class="return-details">
    ...
    <form action="{{route('borrow.update',$borrow->id)}}" method="POST">
        ...
        <table class="detail-table">
            ...
            <tr>
                <td>Return Date:</td>
                <td>{{ $borrow->return_date = now()->format('Y-m-d')}}</td>
            </tr>
            <tr>
                <td>Fine Amount:</td>
            ...
            <tr>
                ...
                <td>
                    <select name="fine_status">
                        ...
                        <option value="paid" {{ $borrow->fine_status === 'paid' ? 'selected' : '' }}>Paid</option>
                        <option value="pending" {{ $borrow->fine_status === 'pending' ? 'selected' : '' }}>Pending</option>
                    </select>
                </td>
            </tr>
